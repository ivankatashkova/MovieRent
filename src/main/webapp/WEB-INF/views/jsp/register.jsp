...
<h3 style= "color:black; text-align:center; margin-top:10px;">Here you can rent and buy movies</h3>
	<div style= "margin:auto;border:1px solid silver;padding:10px;text-align:center;width:30%; margin-top:100px;background-color:white;">
		<form action="register" method="post">
			...
			<p><input type = "text" placeholder = "first name" name = "firstname" required maxlength = "255"></p>
			<p><input type = "text" placeholder = "last name" name = "lastname" required maxlength = "255"></p>
			<p><input type = "text" placeholder = "email" name = "email" required maxlength = "255"></p>
			<p><input type = "password" placeholder = "password" name = "password" required maxlength = "30"></p>
			<p><input type = "password" placeholder = "confirm password" name = "confirmpassword" required maxlength = "30"></p>
